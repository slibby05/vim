...
hi TabLineFill	  term=bold,reverse  cterm=bold ctermfg=lightblue ctermbg=black gui=bold guifg=blue guibg=black
hi TabLineSel	  term=reverse	ctermfg=black ctermbg=lightblue guifg=black guibg=blue
